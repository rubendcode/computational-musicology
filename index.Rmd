...
This project mainly looked at the differences of the pop song Murder On The Dancefloor and its cover. I created chordograms to understand the chords used in the song. Similarly, looking at chromagrams helped me see the notes and keys that are more common in indie pop. Through cepstograms, I examined the timbre of songs, which is like looking at their color or texture in terms of sound. Seeing the differences in the songs ended up being hard since the cover version was a live version. This does not seem to works as well to compare the original song.
...
Looking at time signatures was another eye-opener. Indie pop songs were more likely to use 3/4 time signatures, which can give a song an unusual rhythm or feel.
